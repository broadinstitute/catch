"""Dataset with 'Tapara virus' sequences.

A dataset with 3 'Tapara virus' sequences. The virus is segmented and
...
for f in listdir(join(dirname(__file__), "data/tapara/")):
    ds.add_fasta_path("data/tapara/" + f, relative=True)
