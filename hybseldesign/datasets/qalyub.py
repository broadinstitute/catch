"""Dataset with 'Qalyub orthonairovirus' sequences.

A dataset with 2 'Qalyub orthonairovirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/qalyub/")):
    ds.add_fasta_path("data/qalyub/" + f, relative=True)
