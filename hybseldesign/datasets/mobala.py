"""Dataset with 'Mobala mammarenavirus' sequences.

A dataset with 2 'Mobala mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/mobala/")):
    ds.add_fasta_path("data/mobala/" + f, relative=True)
