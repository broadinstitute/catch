"""Dataset with 'Sabia mammarenavirus' sequences.

A dataset with 5 'Sabia mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/sabia/")):
    ds.add_fasta_path("data/sabia/" + f, relative=True)
