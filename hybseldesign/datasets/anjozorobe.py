"""Dataset with 'Anjozorobe hantavirus' sequences.

A dataset with 2 'Anjozorobe hantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/anjozorobe/")):
    ds.add_fasta_path("data/anjozorobe/" + f, relative=True)
