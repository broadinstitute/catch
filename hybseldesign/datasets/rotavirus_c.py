...
A dataset with 599 'Rotavirus C' sequences. The virus is segmented and
has 11 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 355 genomes. Many genomes may have fewer
than 11 segments.
...
for f in listdir(join(dirname(__file__), "data/rotavirus_c/")):
    ds.add_fasta_path("data/rotavirus_c/" + f, relative=True)
