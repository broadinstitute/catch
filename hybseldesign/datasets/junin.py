"""Dataset with 'Junin mammarenavirus' sequences.

A dataset with 31 'Junin mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/junin/")):
    ds.add_fasta_path("data/junin/" + f, relative=True)
