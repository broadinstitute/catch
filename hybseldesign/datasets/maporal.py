"""Dataset with 'Maporal orthohantavirus' sequences.

A dataset with 2 'Maporal orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/maporal/")):
    ds.add_fasta_path("data/maporal/" + f, relative=True)
