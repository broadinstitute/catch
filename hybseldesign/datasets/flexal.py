"""Dataset with 'Flexal mammarenavirus' sequences.

A dataset with 2 'Flexal mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/flexal/")):
    ds.add_fasta_path("data/flexal/" + f, relative=True)
