"""Dataset with 'Jeju orthohantavirus' sequences.

A dataset with 3 'Jeju orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/jeju/")):
    ds.add_fasta_path("data/jeju/" + f, relative=True)
