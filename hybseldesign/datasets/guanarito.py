"""Dataset with 'Guanarito mammarenavirus' sequences.

A dataset with 15 'Guanarito mammarenavirus' sequences. The virus is
segmented and has 2 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 15 genomes. Many genomes
...
for f in listdir(join(dirname(__file__), "data/guanarito/")):
    ds.add_fasta_path("data/guanarito/" + f, relative=True)
