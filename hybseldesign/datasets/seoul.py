"""Dataset with 'Seoul virus' sequences.

A dataset with 91 'Seoul virus' sequences. The virus is segmented and
has 3 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 72 genomes. Many genomes may have fewer
than 3 segments.
...
for f in listdir(join(dirname(__file__), "data/seoul/")):
    ds.add_fasta_path("data/seoul/" + f, relative=True)
