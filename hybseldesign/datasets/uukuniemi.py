"""Dataset with 'Uukuniemi virus' sequences.

A dataset with 35 'Uukuniemi virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 18 genomes. Many genomes may
...
for f in listdir(join(dirname(__file__), "data/uukuniemi/")):
    ds.add_fasta_path("data/uukuniemi/" + f, relative=True)
