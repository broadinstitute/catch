"""Dataset with 'Banna virus' sequences.

A dataset with 62 'Banna virus' sequences. The virus is segmented and
has 12 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 18 genomes. Many genomes may have fewer
than 12 segments.
...
for f in listdir(join(dirname(__file__), "data/banna/")):
    ds.add_fasta_path("data/banna/" + f, relative=True)
