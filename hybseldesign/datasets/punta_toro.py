"""Dataset with 'Punta Toro virus' sequences.

A dataset with 41 'Punta Toro virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 21 genomes. Many genomes may
