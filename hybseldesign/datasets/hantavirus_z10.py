"""Dataset with 'Hantavirus Z10' sequences.

A dataset with 4 'Hantavirus Z10' sequences. The virus is segmented
...
for f in listdir(join(dirname(__file__), "data/hantavirus_z10/")):
    ds.add_fasta_path("data/hantavirus_z10/" + f, relative=True)
