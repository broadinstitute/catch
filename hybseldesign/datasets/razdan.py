"""Dataset with 'Razdan virus' sequences.

A dataset with 3 'Razdan virus' sequences. The virus is segmented and
...
for f in listdir(join(dirname(__file__), "data/razdan/")):
    ds.add_fasta_path("data/razdan/" + f, relative=True)
