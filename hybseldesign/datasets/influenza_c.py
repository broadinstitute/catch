...
A dataset with 7 'Influenza C virus' sequences. The virus is segmented
and has 7 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 1 genomes. Many genomes may
have fewer than 7 segments.
