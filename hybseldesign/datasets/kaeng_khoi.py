"""Dataset with 'Kaeng Khoi orthobunyavirus' sequences.

A dataset with 4 'Kaeng Khoi orthobunyavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/kaeng_khoi/")):
    ds.add_fasta_path("data/kaeng_khoi/" + f, relative=True)
