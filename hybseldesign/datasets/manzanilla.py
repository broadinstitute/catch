"""Dataset with 'Manzanilla virus' sequences.

A dataset with 6 'Manzanilla virus' sequences. The virus is segmented
...
for f in listdir(join(dirname(__file__), "data/manzanilla/")):
    ds.add_fasta_path("data/manzanilla/" + f, relative=True)
