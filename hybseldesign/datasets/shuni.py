"""Dataset with 'Shuni orthobunyavirus' sequences.

A dataset with 12 'Shuni orthobunyavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/shuni/")):
    ds.add_fasta_path("data/shuni/" + f, relative=True)
