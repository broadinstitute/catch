"""Dataset with 'Sin Nombre orthohantavirus' sequences.

A dataset with 20 'Sin Nombre orthohantavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 14 genomes. Many genomes
...
for f in listdir(join(dirname(__file__), "data/sin_nombre/")):
    ds.add_fasta_path("data/sin_nombre/" + f, relative=True)
