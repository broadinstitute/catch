"""Dataset with 'Sin Nombre virus' sequences.

A dataset with 27 'Sin Nombre virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 22 genomes. Many genomes may
