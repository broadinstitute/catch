"""Dataset with 'Ippy mammarenavirus' sequences.

A dataset with 2 'Ippy mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/ippy/")):
    ds.add_fasta_path("data/ippy/" + f, relative=True)
