"""Dataset with 'Imjin orthohantavirus' sequences.

A dataset with 3 'Imjin orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/imjin/")):
    ds.add_fasta_path("data/imjin/" + f, relative=True)
