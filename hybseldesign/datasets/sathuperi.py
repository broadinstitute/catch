...
A dataset with 73 'Sathuperi orthobunyavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 57 genomes. Many genomes
...
for f in listdir(join(dirname(__file__), "data/sathuperi/")):
    ds.add_fasta_path("data/sathuperi/" + f, relative=True)
