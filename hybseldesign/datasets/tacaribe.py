...
A dataset with 4 'Tacaribe mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/tacaribe/")):
    ds.add_fasta_path("data/tacaribe/" + f, relative=True)
