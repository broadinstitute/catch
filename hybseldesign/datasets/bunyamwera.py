"""Dataset with 'Bunyamwera virus' sequences.

A dataset with 64 'Bunyamwera virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 46 genomes. Many genomes may
