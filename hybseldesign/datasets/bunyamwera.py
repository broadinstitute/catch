...
A dataset with 81 'Bunyamwera orthobunyavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 67 genomes. Many genomes
...
for f in listdir(join(dirname(__file__), "data/bunyamwera/")):
    ds.add_fasta_path("data/bunyamwera/" + f, relative=True)
