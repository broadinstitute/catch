"""Dataset with 'Akabane virus' sequences.

A dataset with 74 'Akabane virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 62 genomes. Many genomes may
