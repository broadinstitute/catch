"""Dataset with 'Capim orthobunyavirus' sequences.

A dataset with 2 'Capim orthobunyavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/capim/")):
    ds.add_fasta_path("data/capim/" + f, relative=True)
