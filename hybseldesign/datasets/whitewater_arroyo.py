"""Dataset with 'Whitewater Arroyo mammarenavirus' sequences.

A dataset with 12 'Whitewater Arroyo mammarenavirus' sequences. The
virus is segmented and has 2 segments. Based on their strain and/or
isolate, these sequences were able to be grouped into 12 genomes. Many
...
for f in listdir(join(dirname(__file__), "data/whitewater_arroyo/")):
    ds.add_fasta_path("data/whitewater_arroyo/" + f, relative=True)
