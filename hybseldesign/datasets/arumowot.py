"""Dataset with 'Arumowot virus' sequences.

A dataset with 3 'Arumowot virus' sequences. The virus is segmented
...
for f in listdir(join(dirname(__file__), "data/arumowot/")):
    ds.add_fasta_path("data/arumowot/" + f, relative=True)
