"""Dataset with 'Simbu virus' sequences.

A dataset with 3 'Simbu virus' sequences. The virus is segmented and
...
for f in listdir(join(dirname(__file__), "data/simbu/")):
    ds.add_fasta_path("data/simbu/" + f, relative=True)
