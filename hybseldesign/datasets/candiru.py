"""Dataset with 'Candiru phlebovirus' sequences.

A dataset with 28 'Candiru phlebovirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 27 genomes. Many genomes
...
for f in listdir(join(dirname(__file__), "data/candiru/")):
    ds.add_fasta_path("data/candiru/" + f, relative=True)
