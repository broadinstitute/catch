"""Dataset with 'Candiru virus' sequences.

A dataset with 39 'Candiru virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 37 genomes. Many genomes may
