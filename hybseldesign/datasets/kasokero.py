"""Dataset with 'Kasokero orthonairovirus' sequences.

A dataset with 2 'Kasokero orthonairovirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/kasokero/")):
    ds.add_fasta_path("data/kasokero/" + f, relative=True)
