"""Dataset with 'Rotavirus B' sequences.

A dataset with 126 'Rotavirus B' sequences. The virus is segmented and
has 11 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 90 genomes. Many genomes may have fewer
than 11 segments.
...
for f in listdir(join(dirname(__file__), "data/rotavirus_b/")):
    ds.add_fasta_path("data/rotavirus_b/" + f, relative=True)
