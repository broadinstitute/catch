"""Dataset with 'Latino mammarenavirus' sequences.

A dataset with 2 'Latino mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/latino/")):
    ds.add_fasta_path("data/latino/" + f, relative=True)
