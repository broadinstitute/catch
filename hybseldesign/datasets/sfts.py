"""Dataset with 'SFTS phlebovirus' sequences.

A dataset with 621 'SFTS phlebovirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 385 genomes. Many genomes
