"""Dataset with 'Hantaan orthohantavirus' sequences.

A dataset with 288 'Hantaan orthohantavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 202 genomes. Many genomes
...
for f in listdir(join(dirname(__file__), "data/hantaan/")):
    ds.add_fasta_path("data/hantaan/" + f, relative=True)
