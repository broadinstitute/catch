"""Dataset with 'Hantaan virus' sequences.

A dataset with 124 'Hantaan virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 86 genomes. Many genomes may
