"""Dataset with 'Pichinde mammarenavirus' sequences.

A dataset with 15 'Pichinde mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/pichinde/")):
    ds.add_fasta_path("data/pichinde/" + f, relative=True)
