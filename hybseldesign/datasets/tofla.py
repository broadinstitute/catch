"""Dataset with 'Tofla virus' sequences.

A dataset with 3 'Tofla virus' sequences. The virus is segmented and
...
for f in listdir(join(dirname(__file__), "data/tofla/")):
    ds.add_fasta_path("data/tofla/" + f, relative=True)
