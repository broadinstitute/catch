"""Dataset with 'Oropouche virus' sequences.

A dataset with 32 'Oropouche virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 19 genomes. Many genomes may
