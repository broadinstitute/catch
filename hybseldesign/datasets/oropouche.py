"""Dataset with 'Oropouche orthobunyavirus' sequences.

A dataset with 32 'Oropouche orthobunyavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/oropouche/")):
    ds.add_fasta_path("data/oropouche/" + f, relative=True)
