"""Dataset with 'Machupo mammarenavirus' sequences.

A dataset with 29 'Machupo mammarenavirus' sequences. The virus is
segmented and has 2 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 24 genomes. Many genomes
...
for f in listdir(join(dirname(__file__), "data/machupo/")):
    ds.add_fasta_path("data/machupo/" + f, relative=True)
