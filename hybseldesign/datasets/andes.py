"""Dataset with 'Andes virus' sequences.

A dataset with 21 'Andes virus' sequences. The virus is segmented and
has 3 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 16 genomes. Many genomes may have fewer
than 3 segments.
...
for f in listdir(join(dirname(__file__), "data/andes/")):
    ds.add_fasta_path("data/andes/" + f, relative=True)
