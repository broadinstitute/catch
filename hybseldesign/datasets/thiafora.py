"""Dataset with 'Thiafora orthonairovirus' sequences.

A dataset with 3 'Thiafora orthonairovirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/thiafora/")):
    ds.add_fasta_path("data/thiafora/" + f, relative=True)
