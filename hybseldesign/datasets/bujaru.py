"""Dataset with 'Bujaru phlebovirus' sequences.

A dataset with 5 'Bujaru phlebovirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/bujaru/")):
    ds.add_fasta_path("data/bujaru/" + f, relative=True)
