"""Dataset with 'Bowe orthohantavirus' sequences.

A dataset with 3 'Bowe orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/bowe/")):
    ds.add_fasta_path("data/bowe/" + f, relative=True)
