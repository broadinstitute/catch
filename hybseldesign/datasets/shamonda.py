"""Dataset with 'Shamonda virus' sequences.

A dataset with 12 'Shamonda virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 6 genomes. Many genomes may
