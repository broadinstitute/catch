"""Dataset with 'Puumala virus' sequences.

A dataset with 103 'Puumala virus' sequences. The virus is segmented
and has 3 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 75 genomes. Many genomes may
