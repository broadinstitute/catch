"""Dataset with 'Puumala orthohantavirus' sequences.

A dataset with 94 'Puumala orthohantavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 74 genomes. Many genomes
...
for f in listdir(join(dirname(__file__), "data/puumala/")):
    ds.add_fasta_path("data/puumala/" + f, relative=True)
