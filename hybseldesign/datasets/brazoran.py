"""Dataset with 'Brazoran virus' sequences.

A dataset with 3 'Brazoran virus' sequences. The virus is segmented
...
for f in listdir(join(dirname(__file__), "data/brazoran/")):
    ds.add_fasta_path("data/brazoran/" + f, relative=True)
