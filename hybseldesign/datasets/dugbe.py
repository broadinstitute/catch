"""Dataset with 'Dugbe orthonairovirus' sequences.

A dataset with 5 'Dugbe orthonairovirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/dugbe/")):
    ds.add_fasta_path("data/dugbe/" + f, relative=True)
