"""Dataset with 'Salehabad phlebovirus' sequences.

A dataset with 4 'Salehabad phlebovirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/salehabad/")):
    ds.add_fasta_path("data/salehabad/" + f, relative=True)
