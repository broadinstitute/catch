"""Dataset with 'Amapari mammarenavirus' sequences.

A dataset with 4 'Amapari mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/amapari/")):
    ds.add_fasta_path("data/amapari/" + f, relative=True)
