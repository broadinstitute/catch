"""Dataset with 'Khabarovsk orthohantavirus' sequences.

A dataset with 5 'Khabarovsk orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/khabarovsk/")):
    ds.add_fasta_path("data/khabarovsk/" + f, relative=True)
