"""Dataset with 'Nyando orthobunyavirus' sequences.

A dataset with 3 'Nyando orthobunyavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/nyando/")):
    ds.add_fasta_path("data/nyando/" + f, relative=True)
