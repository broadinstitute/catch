"""Dataset with 'Tula orthohantavirus' sequences.

A dataset with 15 'Tula orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/tula/")):
    ds.add_fasta_path("data/tula/" + f, relative=True)
