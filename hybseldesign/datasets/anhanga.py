"""Dataset with 'Anhanga virus' sequences.

A dataset with 3 'Anhanga virus' sequences. The virus is segmented and
...
for f in listdir(join(dirname(__file__), "data/anhanga/")):
    ds.add_fasta_path("data/anhanga/" + f, relative=True)
