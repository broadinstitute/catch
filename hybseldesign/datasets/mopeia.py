"""Dataset with 'Mopeia mammarenavirus' sequences.

A dataset with 4 'Mopeia mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/mopeia/")):
    ds.add_fasta_path("data/mopeia/" + f, relative=True)
