"""Dataset with 'Montano orthohantavirus' sequences.

A dataset with 2 'Montano orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/montano/")):
    ds.add_fasta_path("data/montano/" + f, relative=True)
