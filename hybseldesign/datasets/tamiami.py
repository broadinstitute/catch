"""Dataset with 'Tamiami mammarenavirus' sequences.

A dataset with 5 'Tamiami mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/tamiami/")):
    ds.add_fasta_path("data/tamiami/" + f, relative=True)
