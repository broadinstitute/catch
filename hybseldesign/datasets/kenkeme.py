"""Dataset with 'Kenkeme orthohantavirus' sequences.

A dataset with 3 'Kenkeme orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/kenkeme/")):
    ds.add_fasta_path("data/kenkeme/" + f, relative=True)
