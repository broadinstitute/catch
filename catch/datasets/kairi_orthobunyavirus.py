"""Dataset with 'Kairi orthobunyavirus' sequences.

A dataset with 12 'Kairi orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/kairi_orthobunyavirus.fasta.gz", relative=True)
