"""Dataset with 'Batama orthobunyavirus' sequences.

A dataset with 1 'Batama orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/batama_orthobunyavirus.fasta.gz", relative=True)
