"""Dataset with 'Fugong orthohantavirus' sequences.

A dataset with 3 'Fugong orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/fugong_orthohantavirus.fasta.gz", relative=True)
