"""Dataset with 'Prospect Hill orthohantavirus' sequences.

A dataset with 3 'Prospect Hill orthohantavirus' sequences. The virus
...
ds.add_fasta_path("data/prospect_hill_orthohantavirus.fasta.gz", relative=True)
