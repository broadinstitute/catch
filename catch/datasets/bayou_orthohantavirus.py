"""Dataset with 'Bayou orthohantavirus' sequences.

A dataset with 3 'Bayou orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/bayou_orthohantavirus.fasta.gz", relative=True)
