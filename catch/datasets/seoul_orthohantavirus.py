...
A dataset with 207 'Seoul orthohantavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 155 genomes. Many genomes
...
ds.add_fasta_path("data/seoul_orthohantavirus.fasta.gz", relative=True)
