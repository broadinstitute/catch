...
A dataset with 39 'Candiru phlebovirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 37 genomes. Many genomes
...
ds.add_fasta_path("data/candiru_phlebovirus.fasta.gz", relative=True)
