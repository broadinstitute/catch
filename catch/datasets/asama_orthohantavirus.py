"""Dataset with 'Asama orthohantavirus' sequences.

A dataset with 3 'Asama orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/asama_orthohantavirus.fasta.gz", relative=True)
