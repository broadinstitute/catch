...
A dataset with 78 'Lymphocytic choriomeningitis mammarenavirus'
sequences. The virus is segmented and has 2 segments. Based on their
strain and/or isolate, these sequences were able to be grouped into 54
...
ds.add_fasta_path("data/lymphocytic_choriomeningitis_mammarenavirus.fasta.gz", relative=True)
