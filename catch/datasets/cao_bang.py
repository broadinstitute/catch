"""Dataset with 'Cao Bang orthohantavirus' sequences.

A dataset with 1 'Cao Bang orthohantavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/cao_bang/")):
    ds.add_fasta_path("data/cao_bang/" + f, relative=True)
