...
A dataset with 51 'Liao ning virus' sequences. The virus is segmented
and has 12 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 13 genomes. Many genomes may
...
ds.add_fasta_path("data/liao_ning.fasta.gz", relative=True)
