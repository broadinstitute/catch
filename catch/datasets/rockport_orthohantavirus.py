"""Dataset with 'Rockport orthohantavirus' sequences.

A dataset with 7 'Rockport orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/rockport_orthohantavirus.fasta.gz", relative=True)
