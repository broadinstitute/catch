"""Dataset with 'Nova orthohantavirus' sequences.

A dataset with 120 'Nova orthohantavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 103 genomes. Many genomes
...
ds.add_fasta_path("data/nova_orthohantavirus.fasta.gz", relative=True)
