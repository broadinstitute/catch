"""Dataset with 'Uukuniemi phlebovirus' sequences.

A dataset with 46 'Uukuniemi phlebovirus' sequences. The virus is
...
ds.add_fasta_path("data/uukuniemi_phlebovirus.fasta.gz", relative=True)
