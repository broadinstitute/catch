"""Dataset with 'Dera Ghazi Khan orthonairovirus' sequences.

A dataset with 7 'Dera Ghazi Khan orthonairovirus' sequences. The
...
ds.add_fasta_path("data/dera_ghazi_khan_orthonairovirus.fasta.gz", relative=True)
