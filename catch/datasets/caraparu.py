...
A dataset with 1 'Caraparu orthobunyavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/caraparu/")):
    ds.add_fasta_path("data/caraparu/" + f, relative=True)
