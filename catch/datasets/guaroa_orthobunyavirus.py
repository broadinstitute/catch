...
A dataset with 39 'Guaroa orthobunyavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 17 genomes. Many genomes
...
ds.add_fasta_path("data/guaroa_orthobunyavirus.fasta.gz", relative=True)
