"""Dataset with 'Guama orthobunyavirus' sequences.

A dataset with 5 'Guama orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/guama_orthobunyavirus.fasta.gz", relative=True)
