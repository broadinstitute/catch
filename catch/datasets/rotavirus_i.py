...
A dataset with 29 'Rotavirus I' sequences. The virus is segmented and
has 11 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 5 genomes. Many genomes may have fewer
than 11 segments.
...
ds.add_fasta_path("data/rotavirus_i.fasta.gz", relative=True)
