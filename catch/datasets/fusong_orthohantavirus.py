"""Dataset with 'Fusong orthohantavirus' sequences.

A dataset with 2 'Fusong orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/fusong_orthohantavirus.fasta.gz", relative=True)
