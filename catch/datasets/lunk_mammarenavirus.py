"""Dataset with 'Lunk mammarenavirus' sequences.

A dataset with 2 'Lunk mammarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/lunk_mammarenavirus.fasta.gz", relative=True)
