"""Dataset with 'Loei River mammarenavirus' sequences.

A dataset with 5 'Loei River mammarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/loei_river_mammarenavirus.fasta.gz", relative=True)
