"""Dataset with 'Yakeshi orthohantavirus' sequences.

A dataset with 2 'Yakeshi orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/yakeshi_orthohantavirus.fasta.gz", relative=True)
