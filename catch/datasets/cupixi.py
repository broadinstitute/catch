"""Dataset with 'Cupixi mammarenavirus' sequences.

A dataset with 1 'Cupixi mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/cupixi/")):
    ds.add_fasta_path("data/cupixi/" + f, relative=True)
