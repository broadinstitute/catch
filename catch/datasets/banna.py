...
A dataset with 118 'Banna virus' sequences. The virus is segmented and
has 12 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 40 genomes. Many genomes may have fewer
than 12 segments.
...
ds.add_fasta_path("data/banna.fasta.gz", relative=True)
