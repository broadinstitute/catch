"""Dataset with 'Giessen reptarenavirus' sequences.

A dataset with 5 'Giessen reptarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/giessen_reptarenavirus.fasta.gz", relative=True)
