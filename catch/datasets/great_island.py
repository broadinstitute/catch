...
A dataset with 62 'Great Island virus' sequences. The virus is
segmented and has 10 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 30 genomes. Many genomes
...
ds.add_fasta_path("data/great_island.fasta.gz", relative=True)
