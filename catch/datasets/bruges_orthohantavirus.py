"""Dataset with 'Bruges orthohantavirus' sequences.

A dataset with 6 'Bruges orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/bruges_orthohantavirus.fasta.gz", relative=True)
