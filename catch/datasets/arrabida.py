"""Dataset with 'Arrabida virus' sequences.

A dataset with 3 'Arrabida virus' sequences. The virus is segmented
...
ds.add_fasta_path("data/arrabida.fasta.gz", relative=True)
