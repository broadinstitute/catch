"""Dataset with 'Dabieshan orthohantavirus' sequences.

A dataset with 2 'Dabieshan orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/dabieshan_orthohantavirus.fasta.gz", relative=True)
