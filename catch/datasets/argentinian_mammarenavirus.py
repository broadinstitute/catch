"""Dataset with 'Argentinian mammarenavirus' sequences.

A dataset with 54 'Argentinian mammarenavirus' sequences. The virus is
segmented and has 2 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 40 genomes. Many genomes
...
ds.add_fasta_path("data/argentinian_mammarenavirus.fasta.gz", relative=True)
