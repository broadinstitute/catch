"""Dataset with 'Tacaiuma orthobunyavirus' sequences.

A dataset with 6 'Tacaiuma orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/tacaiuma_orthobunyavirus.fasta.gz", relative=True)
