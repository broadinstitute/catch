"""Dataset with 'Koongol orthobunyavirus' sequences.

A dataset with 3 'Koongol orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/koongol_orthobunyavirus.fasta.gz", relative=True)
