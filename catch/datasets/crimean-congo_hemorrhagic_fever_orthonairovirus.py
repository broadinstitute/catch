"""Dataset with 'Crimean-Congo hemorrhagic fever orthonairovirus'
sequences.

A dataset with 448 'Crimean-Congo hemorrhagic fever orthonairovirus'
...
225 genomes. Many genomes may have fewer than 3 segments.
...
ds.add_fasta_path("data/crimean-congo_hemorrhagic_fever_orthonairovirus.fasta.gz", relative=True)
