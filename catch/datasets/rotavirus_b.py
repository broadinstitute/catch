...
A dataset with 459 'Rotavirus B' sequences. The virus is segmented and
has 11 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 188 genomes. Many genomes may have fewer
than 11 segments.
...
ds.add_fasta_path("data/rotavirus_b.fasta.gz", relative=True)
