"""Dataset with 'Hazara orthonairovirus' sequences.

A dataset with 7 'Hazara orthonairovirus' sequences. The virus is
...
ds.add_fasta_path("data/hazara_orthonairovirus.fasta.gz", relative=True)
