"""Dataset with 'Rift Valley fever phlebovirus' sequences.

A dataset with 419 'Rift Valley fever phlebovirus' sequences. The
virus is segmented and has 3 segments. Based on their strain and/or
isolate, these sequences were able to be grouped into 196 genomes.
Many genomes may have fewer than 3 segments.
...
ds.add_fasta_path("data/rift_valley_fever_phlebovirus.fasta.gz", relative=True)
