...
A dataset with 2 'Lujo mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/lujo/")):
    ds.add_fasta_path("data/lujo/" + f, relative=True)
