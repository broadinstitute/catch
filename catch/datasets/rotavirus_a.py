...
A dataset with 59686 'Rotavirus A' sequences. The virus is segmented
and has 11 segments. Based on their strain and/or isolate, these
sequences were able to be grouped into 24282 genomes. Many genomes may
...
ds.add_fasta_path("data/rotavirus_a.fasta.gz", relative=True)
