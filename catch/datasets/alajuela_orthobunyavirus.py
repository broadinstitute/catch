"""Dataset with 'Alajuela orthobunyavirus' sequences.

A dataset with 3 'Alajuela orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/alajuela_orthobunyavirus.fasta.gz", relative=True)
