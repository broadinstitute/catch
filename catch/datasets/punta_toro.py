"""Dataset with 'Punta Toro phlebovirus' sequences.

A dataset with 38 'Punta Toro phlebovirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/punta_toro/")):
    ds.add_fasta_path("data/punta_toro/" + f, relative=True)
