...
A dataset with 156 'Puumala orthohantavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 117 genomes. Many genomes
...
ds.add_fasta_path("data/puumala_orthohantavirus.fasta.gz", relative=True)
