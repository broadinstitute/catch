"""Dataset with 'Urucuri virus' sequences.

A dataset with 3 'Urucuri virus' sequences. The virus is segmented and
...
for f in listdir(join(dirname(__file__), "data/urucuri/")):
    ds.add_fasta_path("data/urucuri/" + f, relative=True)
