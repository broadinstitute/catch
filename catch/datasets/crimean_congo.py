...
A dataset with 252 'Crimean-Congo hemorrhagic fever orthonairovirus'
...
153 genomes. Many genomes may have fewer than 3 segments.
...
ds.add_fasta_path("data/crimean_congo.fasta", relative=True)
