...
A dataset with 1 'Oriboca orthobunyavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/oriboca/")):
    ds.add_fasta_path("data/oriboca/" + f, relative=True)
