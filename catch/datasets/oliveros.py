"""Dataset with 'Oliveros mammarenavirus' sequences.

A dataset with 1 'Oliveros mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/oliveros/")):
    ds.add_fasta_path("data/oliveros/" + f, relative=True)
