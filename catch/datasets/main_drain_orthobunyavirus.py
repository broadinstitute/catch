"""Dataset with 'Main Drain orthobunyavirus' sequences.

A dataset with 9 'Main Drain orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/main_drain_orthobunyavirus.fasta.gz", relative=True)
