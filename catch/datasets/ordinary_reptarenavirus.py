"""Dataset with 'Ordinary reptarenavirus' sequences.

A dataset with 4 'Ordinary reptarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/ordinary_reptarenavirus.fasta.gz", relative=True)
