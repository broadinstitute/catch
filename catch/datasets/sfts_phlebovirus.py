...
A dataset with 1214 'SFTS phlebovirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 589 genomes. Many genomes
...
ds.add_fasta_path("data/sfts_phlebovirus.fasta.gz", relative=True)
