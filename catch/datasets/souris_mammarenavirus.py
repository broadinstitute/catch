"""Dataset with 'Souris mammarenavirus' sequences.

A dataset with 2 'Souris mammarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/souris_mammarenavirus.fasta.gz", relative=True)
