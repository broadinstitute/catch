"""Dataset with 'Bunyamwera orthobunyavirus' sequences.

A dataset with 198 'Bunyamwera orthobunyavirus' sequences. The virus
is segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 135 genomes. Many genomes
...
ds.add_fasta_path("data/bunyamwera_orthobunyavirus.fasta.gz", relative=True)
