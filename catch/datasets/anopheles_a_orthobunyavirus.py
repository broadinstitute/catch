"""Dataset with 'Anopheles A orthobunyavirus' sequences.

A dataset with 3 'Anopheles A orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/anopheles_a_orthobunyavirus.fasta.gz", relative=True)
