...
A dataset with 46 'Mopeia Lassa virus reassortant 29' sequences. The
virus is segmented and has 2 segments. Based on their strain and/or
isolate, these sequences were able to be grouped into 23 genomes. Many
...
ds.add_fasta_path("data/mopeia_lassa_virus_reassortant_29.fasta.gz", relative=True)
