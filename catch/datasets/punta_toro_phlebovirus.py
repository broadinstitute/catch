...
A dataset with 54 'Punta Toro phlebovirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 31 genomes. Many genomes
...
ds.add_fasta_path("data/punta_toro_phlebovirus.fasta.gz", relative=True)
