"""Dataset with 'Akabane orthobunyavirus' sequences.

A dataset with 167 'Akabane orthobunyavirus' sequences. The virus is
segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 113 genomes. Many genomes
...
ds.add_fasta_path("data/akabane_orthobunyavirus.fasta.gz", relative=True)
