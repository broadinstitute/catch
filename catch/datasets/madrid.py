"""Dataset with 'Madrid orthobunyavirus' sequences.

A dataset with 2 'Madrid orthobunyavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/madrid/")):
    ds.add_fasta_path("data/madrid/" + f, relative=True)
