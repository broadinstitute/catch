...
A dataset with 121 'Sandfly fever Naples phlebovirus' sequences. The
virus is segmented and has 3 segments. Based on their strain and/or
isolate, these sequences were able to be grouped into 77 genomes. Many
...
ds.add_fasta_path("data/sandfly_fever_naples_phlebovirus.fasta.gz", relative=True)
