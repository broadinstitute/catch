"""Dataset with 'Sangassou orthohantavirus' sequences.

A dataset with 3 'Sangassou orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/sangassou_orthohantavirus.fasta.gz", relative=True)
