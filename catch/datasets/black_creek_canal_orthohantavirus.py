"""Dataset with 'Black creek canal orthohantavirus' sequences.

A dataset with 3 'Black creek canal orthohantavirus' sequences. The
virus is segmented and has 3 segments. Based on their strain and/or
isolate, these sequences were able to be grouped into 3 genomes. Many
...
ds.add_fasta_path("data/black_creek_canal_orthohantavirus.fasta.gz", relative=True)
