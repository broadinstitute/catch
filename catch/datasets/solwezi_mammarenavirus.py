"""Dataset with 'Solwezi mammarenavirus' sequences.

A dataset with 2 'Solwezi mammarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/solwezi_mammarenavirus.fasta.gz", relative=True)
