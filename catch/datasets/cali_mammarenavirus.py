"""Dataset with 'Cali mammarenavirus' sequences.

A dataset with 15 'Cali mammarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/cali_mammarenavirus.fasta.gz", relative=True)
