"""Dataset with 'Cano Delgadito orthohantavirus' sequences.

A dataset with 3 'Cano Delgadito orthohantavirus' sequences. The virus
...
ds.add_fasta_path("data/cano_delgadito_orthohantavirus.fasta.gz", relative=True)
