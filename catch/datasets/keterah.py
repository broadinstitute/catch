...
A dataset with 1 'Keterah orthonairovirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/keterah/")):
    ds.add_fasta_path("data/keterah/" + f, relative=True)
