"""Dataset with 'Chapare mammarenavirus' sequences.

A dataset with 2 'Chapare mammarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/chapare_mammarenavirus.fasta.gz", relative=True)
