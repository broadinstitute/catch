...
A dataset with 3 'Bear Canyon mammarenavirus' sequences. The virus is
...
for f in listdir(join(dirname(__file__), "data/bear_canyon/")):
    ds.add_fasta_path("data/bear_canyon/" + f, relative=True)
