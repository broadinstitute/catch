"""Dataset with 'Catu orthobunyavirus' sequences.

A dataset with 3 'Catu orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/catu_orthobunyavirus.fasta.gz", relative=True)
