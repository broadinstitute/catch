"""Dataset with 'Golden reptarenavirus' sequences.

A dataset with 2 'Golden reptarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/golden_reptarenavirus.fasta.gz", relative=True)
