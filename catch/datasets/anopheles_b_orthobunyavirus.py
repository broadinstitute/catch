"""Dataset with 'Anopheles B orthobunyavirus' sequences.

A dataset with 1 'Anopheles B orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/anopheles_b_orthobunyavirus.fasta.gz", relative=True)
