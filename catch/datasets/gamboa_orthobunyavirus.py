"""Dataset with 'Gamboa orthobunyavirus' sequences.

A dataset with 9 'Gamboa orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/gamboa_orthobunyavirus.fasta.gz", relative=True)
