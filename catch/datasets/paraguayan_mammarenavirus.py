"""Dataset with 'Paraguayan mammarenavirus' sequences.

A dataset with 3 'Paraguayan mammarenavirus' sequences. The virus is
...
ds.add_fasta_path("data/paraguayan_mammarenavirus.fasta.gz", relative=True)
