"""Dataset with 'Kabuto mountain virus' sequences.

A dataset with 3 'Kabuto mountain virus' sequences. The virus is
...
ds.add_fasta_path("data/kabuto_mountain.fasta.gz", relative=True)
