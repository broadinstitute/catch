"""Dataset with 'Guajara orthobunyavirus' sequences.

A dataset with 3 'Guajara orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/guajara_orthobunyavirus.fasta.gz", relative=True)
