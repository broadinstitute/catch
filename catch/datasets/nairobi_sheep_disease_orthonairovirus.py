...
A dataset with 29 'Nairobi sheep disease orthonairovirus' sequences.
The virus is segmented and has 3 segments. Based on their strain
and/or isolate, these sequences were able to be grouped into 23
...
ds.add_fasta_path("data/nairobi_sheep_disease_orthonairovirus.fasta.gz", relative=True)
