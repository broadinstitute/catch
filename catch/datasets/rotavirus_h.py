...
A dataset with 62 'Rotavirus H' sequences. The virus is segmented and
has 11 segments. Based on their strain and/or isolate, these sequences
were able to be grouped into 46 genomes. Many genomes may have fewer
than 11 segments.
...
ds.add_fasta_path("data/rotavirus_h.fasta.gz", relative=True)
