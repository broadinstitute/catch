"""Dataset with 'Thottapalayam orthohantavirus' sequences.

A dataset with 37 'Thottapalayam orthohantavirus' sequences. The virus
is segmented and has 3 segments. Based on their strain and/or isolate,
these sequences were able to be grouped into 29 genomes. Many genomes
...
ds.add_fasta_path("data/thottapalayam_orthohantavirus.fasta.gz", relative=True)
