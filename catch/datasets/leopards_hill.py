"""Dataset with 'Leopards Hill virus' sequences.

A dataset with 8 'Leopards Hill virus' sequences. The virus is
...
ds.add_fasta_path("data/leopards_hill.fasta.gz", relative=True)
