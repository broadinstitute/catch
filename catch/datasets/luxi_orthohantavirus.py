"""Dataset with 'Luxi orthohantavirus' sequences.

A dataset with 3 'Luxi orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/luxi_orthohantavirus.fasta.gz", relative=True)
