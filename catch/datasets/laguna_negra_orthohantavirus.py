"""Dataset with 'Laguna Negra orthohantavirus' sequences.

A dataset with 2 'Laguna Negra orthohantavirus' sequences. The virus
...
ds.add_fasta_path("data/laguna_negra_orthohantavirus.fasta.gz", relative=True)
