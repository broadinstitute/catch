...
A dataset with 312 'California encephalitis orthobunyavirus'
...
165 genomes. Many genomes may have fewer than 3 segments.
...
ds.add_fasta_path("data/california_encephalitis_orthobunyavirus.fasta.gz", relative=True)
