"""Dataset with 'Bimiti orthobunyavirus' sequences.

A dataset with 3 'Bimiti orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/bimiti_orthobunyavirus.fasta.gz", relative=True)
