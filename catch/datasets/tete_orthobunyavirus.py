"""Dataset with 'Tete orthobunyavirus' sequences.

A dataset with 10 'Tete orthobunyavirus' sequences. The virus is
...
ds.add_fasta_path("data/tete_orthobunyavirus.fasta.gz", relative=True)
