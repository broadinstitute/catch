"""Dataset with 'Laibin orthohantavirus' sequences.

A dataset with 6 'Laibin orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/laibin_orthohantavirus.fasta.gz", relative=True)
