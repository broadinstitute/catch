"""Dataset with 'Choclo orthohantavirus' sequences.

A dataset with 4 'Choclo orthohantavirus' sequences. The virus is
...
ds.add_fasta_path("data/choclo_orthohantavirus.fasta.gz", relative=True)
