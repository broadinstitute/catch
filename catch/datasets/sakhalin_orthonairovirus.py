"""Dataset with 'Sakhalin orthonairovirus' sequences.

A dataset with 10 'Sakhalin orthonairovirus' sequences. The virus is
...
ds.add_fasta_path("data/sakhalin_orthonairovirus.fasta.gz", relative=True)
